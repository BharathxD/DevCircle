...
const UserInterceptor = async ({ params }: UserInterceptorArgs) => {
  ...
  return (
    <div className="fixed inset-0 z-10 flex h-screen max-h-screen w-screen items-center justify-center overflow-hidden rounded-lg bg-zinc-50/20 backdrop-blur-md dark:bg-zinc-800/20">
