...
export function GET(req: Request) {
  try {
    ...
    return new ImageResponse(
      (
        <div
          tw={`h-full w-full bg-zinc-900 flex flex-col justify-center items-center overflow-hidden border-[0.5rem] border-zinc-900 shadow-inner p-0`}
        >
          ...
          <div
            tw="flex max-w-4xl pb-10 pt-0 items-center justify-center flex-col"
            style={{
              whiteSpace: "pre-wrap",
            }}
          >
            <div tw="text-5xl text-center font-extrabold tracking-tight leading-tight text-zinc-50 px-8">
              {title}
            </div>
