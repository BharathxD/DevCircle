...
/**
 * Retrieves forums based on the provided query parameter.
...
const getForums = async (req: NextRequest): Promise<NextResponse> => {
  try {
    ...
    return NextResponse.json(
      {
        message:
          "Something went wrong. The forums cannot be retrieved at the moment.",
      },
