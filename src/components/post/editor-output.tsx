...
const CustomCodeRenderer = dynamic(
  async () => (await import("../renderers/custom-code-renderer")).default,
  { ssr: false }
);
const CustomImageRenderer = dynamic(
  async () => (await import("../renderers/custom-image-renderer")).default,
  { ssr: false }
);
const CustomTableRenderer = dynamic(
  async () => (await import("../renderers/custom-table-renderer")).default,
  { ssr: false }
);
