  ...
  return (
    <div className="mx-auto w-auto flex flex-col justify-center pt-2 pb-6 gap-4 md:px-8 text-center">
      <FiGlobe
        ...
        className="mx-auto"
      />
      <h1 className="text-4xl md:text-4xl -mb-1 h-full font-semibold tracking-tight dark:text-transparent bg-clip-text text-zinc-800 dark:bg-gradient-to-br dark:from-zinc-200 dark:to-zinc-400">
        Register Now
      </h1>
