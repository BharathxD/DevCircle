...
const CreateCommunity = () => {
  return (
    <div className="order-first h-fit overflow-hidden rounded-md border-2 border-zinc-800 md:order-last ">
      <div className="border-b-zinc-80 border-b-2 bg-zinc-800 px-5 py-4 text-zinc-50 dark:bg-zinc-800 ">
      ...
      <div className="flex flex-col gap-4 p-5 text-sm leading-6">
        ...
        <Link
          href="/d/create"
          className="text-md w-full rounded-lg border-2 border-zinc-800 p-3 text-center font-bold text-zinc-700 transition-colors hover:rounded-md hover:bg-zinc-800 hover:text-zinc-50 dark:text-zinc-50"
          passHref
        >
          Create Community
        </Link>
